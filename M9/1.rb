...
=begin
folder1 = FSFolder.new('ABAKA_0')
folder1.addFile(FSFile.new('Artem'))
folder2 = FSFolder.new('ABAKA_1')
folder2.addFile(FSFile.new('Vlad'))
folder2.addFile(FSFile.new('Alex'))
